...
class SimpleQosPublisher(Node):
    ...
    def __init__(self):
        ...
        if reliability == "best_effort":
            ...
            self.get_logger.error("selected Reliability  Qos %s does not exist" %reliability)
            return
